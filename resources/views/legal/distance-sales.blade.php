...
<h3>Alıcı (Üye)</h3>
<p>Platforma kayıt olarak üyelik paketi satın alan gerçek veya tüzel kişi.</p>
...
<ul>
    <li>Yolcu ile eşleştirme hizmeti</li>
    <li>Dijital harita ve navigasyon entegrasyonu</li>
    <li>Bildirim ve iletişim altyapısı</li>
    <li>Yolculuk geçmişi ve analiz</li>
    <li>Müşteri destek erişimi</li>
</ul>
...
<p>
    Üyelik paketi, ödeme onayını takiben anında aktif edilir ve seçilen süre boyunca (günlük/haftalık/aylık) Alıcı'nın
    kullanımına açıktır. Hizmet kesintisiz olarak sunulmaya çalışılır; planlı bakımlar önceden duyurulur.
</p>

<h2>5. Cayma Hakkı</h2>
<p>
    Alıcı, üyelik paketi satın alma tarihinden itibaren <strong>14 (on dört) gün içinde</strong> hiçbir gerekçe göstermeksizin
    cayma hakkına sahiptir. Cayma hakkı, hizmetin tüketildiği kısım için geçerli değildir.
</p>
<p>
    <strong>İstisna:</strong> Mesafeli Sözleşmeler Yönetmeliği m.15/1-(ğ) uyarınca, tüketicinin onayı ile ifaya başlanan ve fesih anına kadar
...
<h2>9. Sözleşmenin Saklanması</h2>
<p>
    Bu sözleşme elektronik ortamda saklanır; Alıcı talebi halinde kayıtlı e-posta adresine PDF olarak iletilir.
</p>

<h2>10. Yürürlük</h2>
<p>
    İşbu sözleşme, Alıcı'nın ödemeyi onaylaması anında kurulur ve yürürlüğe girer.
    Alıcı bu sözleşmeyi okuduğunu, anladığını ve kabul ettiğini "Ödemeyi Onayla" butonuna tıklayarak teyit eder.
</p>
