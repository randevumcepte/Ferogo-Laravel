        ...
        <div class="max-w-7xl mx-auto px-6 py-12 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-x-8 gap-y-10 text-sm text-zinc-400">
            ...
            <div class="col-span-2 md:col-span-3 lg:col-span-1">
                ...
                <div class="flex flex-row lg:flex-col gap-3">
                    {{-- App Store (yakında) --}}
                    <div class="relative inline-flex items-center gap-3 px-4 py-2.5 rounded-xl bg-gradient-to-b from-zinc-800 to-zinc-900 border border-white/20 hover:border-brand/50 shadow-lg shadow-black/50 cursor-default select-none transition-colors" title="Çok yakında">
